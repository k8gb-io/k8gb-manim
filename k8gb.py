...
class FailOver(MovingCameraScene):
    ...
    def pods(self):
        ...
        dns_bubble_title = Text("app.example.com", dns_c, font_size=25, font=font)
        dns_bubble_title.next_to(route_bubble, direction=UP, buff=0.1).shift(RIGHT*0.3)
        self.play(Write(dns_bubble_title))
        dns_bubble_r1 = Text("192.168.0.1 (node @ eu)", dns_c, font_size=17, font=font)
        ...
        ttl_text = Text("(TTL = 30sec)", dns_c, font_size=25, font=font)
        ...
        self.wait(0.2)
        detail_font = 11
        dns_bubble_r1_detailed1 = Text(";; AUTHORITY SECTION:", dns_c, font_size=detail_font, font=font)
        dns_bubble_r1_detailed2 = Text("example.com. 30 IN NS gslb-ns-us-app.example.com.", dns_c, font_size=detail_font, font=font)
        dns_bubble_r1_detailed3 = Text("example.com. 30 IN NS gslb-ns-eu-app.example.com.", dns_c, font_size=detail_font, font=font)
        dns_bubble_r1_detailed4 = Text(";; ADDITIONAL SECTION:", dns_c, font_size=detail_font, font=font)
        dns_bubble_r1_detailed5 = Text("gslb-ns-us-app.example.com. 30 IN A 10.0.0.1", dns_c, font_size=detail_font, font=font)
        dns_bubble_r1_detailed6 = Text("gslb-ns-eu-app.example.com. 30 IN A 10.0.1.1", dns_c, font_size=detail_font, font=font)
        ...
        dot_dns = Dot(dns_c, radius=DEFAULT_DOT_RADIUS*2).move_to(self.camera.frame.get_left()).shift(RIGHT*1.5+UP*1)
        ...
        dns_bubble_r3 = Text("192.168.1.1 (node @ us)", dns_c, font_size=17, font=font)
